        ...
        <div class="sidebar" id= "sidebar">
          ...
          <div class="menus px-3">
            <ul class= "nav flex-column">
              ...
              <li><a href="addIncome.php" class= "nav-link"><i class= "fa fa-plus"></i>Add Income</a></li>
              <li><a href = "../expense/showexpense.php" class= "nav-link"><i class ="fa fa-money"></i>Manage Expenses</a></li>
              <li><a href = "showIncome.php" class= "nav-link"><i class ="fa fa-money"></i>Manage Income</a></li>
