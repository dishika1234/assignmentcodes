        ...
        <div class="sidebar" id= "sidebar">
          ...
          <div class="menus px-3">
            <ul class= "nav flex-column">
              ...
              <li><a href="../expense/addExpense.php" class= "nav-link"><i class= "fa fa-plus"></i>Add Expense</a></li>
              <li><a href="../income/addIncome.php" class= "nav-link"><i class= "fa fa-plus"></i>Add Income</a></li>
              <li><a href = "/expense/showexpense.php" class= "nav-link"><i class ="fa fa-money"></i>Manage Expenses</a></li>
              <li><a href = "../income/showIncome.php" class= "nav-link"><i class ="fa fa-money"></i>Manage Income</a></li>
              <li><a href = "expensevsIncome.php" class= "nav-link"><i class ="fa fa-file"></i>Expense vs Income</a></li>
              <li><a href = "expensesummary.php" class= "nav-link"><i class ="fa fa-file"></i>Expense Summary</a></li>
              <li><a href = "expensedetail.php" class= "nav-link"><i class ="fa fa-file"></i>Expense Detail</a></li>
